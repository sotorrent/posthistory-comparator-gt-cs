...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        String absolutePathOfFXML = String.valueOf(Paths.get("src", "org", "sotorrent", "ComparatorAppOfGroundTruthAndComputedSimilarity", "GroundTruthComputedSimilarityComparator.fxml").toAbsolutePath());
